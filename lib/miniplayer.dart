...
class _MiniplayerState extends State<Miniplayer> with TickerProviderStateMixin {
              ...
              Align(
                ...
                child: SizedBox(
                  ...
                  child: GestureDetector(
                      ...
                      child: Material(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            boxShadow: <BoxShadow>[
                              BoxShadow(color: widget.backgroundBoxShadow, blurRadius: widget.elevation, offset: Offset(0.0, 4))
                            ],
                    ...
                    onTap: widget.isIgnoring || (_dragHeight == widget.maxHeight && !widget.tapToCollapse)
                        ? null
                        : () => _snapToPosition(_dragHeight != widget.maxHeight ? PanelState.MAX : PanelState.MIN),
                    onVerticalDragStart: widget.isIgnoring
                        ? null
                        : (details) {
                    ...
                    onVerticalDragEnd: widget.isIgnoring
                        ? null
                        : (details) async {
                            ...
                            final _percentageMax = percentageFromValueInRange(min: widget.minHeight, max: widget.maxHeight, value: _dragHeight);
                    ...
                    onVerticalDragUpdate: widget.isIgnoring
                        ? null
                        : (details) {
                            if (dismissed) return;
  ...
  void _handleHeightChange({bool animation = false}) {
    ...
    ///Drag below minHeight
      ...
      final percentageDown =
          borderDouble(minRange: 0.0, maxRange: 1.0, value: percentageFromValueInRange(min: widget.minHeight, max: 0, value: _dragHeight));
